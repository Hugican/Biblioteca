...
@RestController
@RequestMapping("/api")
public class CopiaRestController2 {
	...
	@GetMapping("/listado")
	public List<Lector> findLectores() {
		return this.lectorService.getAllLectores();
	}
	
	@GetMapping("/id/{id}")
	public Lector findById(@PathVariable("id") Long id) {
